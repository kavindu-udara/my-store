        ...
        <div class="justify-content-center">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Become a Seller</h4>
                </div>
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="cpassword" id="input-cpassword" class="form-control" required>
                        </div>

                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary" name="seller_register_btn">Register</button>
                        </div>
                    </form>
                </div>
            </div>
